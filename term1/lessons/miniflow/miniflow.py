...
class Linear(Neuron):
    ...
    def forward(self):
        ...
        Your code goes here!
        """
        linearization = self.bias.value
        for inbound_neuron, weight in zip(self.inbound_neurons, self.weights):
            linearization += weight.value * inbound_neuron.value
        self.value = linearization
